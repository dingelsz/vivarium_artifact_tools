...
def reduce_draws(table, val_col="value"):
...
def add_population(table, pop_table):
    ...
    pop_table:
        A pandas DataFrame that contains "age", "sex", "year" and "population"
        columns
    ...
    assert all([col_name in pop_table.columns for col_name in ["age", "year", "sex", "population"]]), "table does not have all the required columns"
